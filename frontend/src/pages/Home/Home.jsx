  ...
  return (
    <div className="home-container">
      ...
      <header className="hero">
        ...
        <button  className="start-btn" onClick={() => setModalOpen(true)}>Start Interview</button>
      </header>
        ...
        <div className="modal" ref={modalRef}>
          ...
          <ul>
            {[
              ...
              <li
                key={index}
                style={selection - 1 === index ? { backgroundColor: "#4CAF50", color: "#fff" } : {backgroundColor: "#555", color: "#fff"}}
          ...
          <div className="action-buttons">
            ...
            <button className="next-btn" onClick={startInterview}>Next</button>
          </div>
        </div>
      </div>
    );
